...
#   commit f1ee155a612eeb78561cdb538e856252d4c8f68e (2026-09-08)
#   ewfprobe.py, MIT License (see LICENSE in this directory)
#
# Crush's own wrapper lives in crush/core/raw_image.py — qnxprobe reaches this
# module by a bare "import ewfprobe", which raw_image.py satisfies by
# registering this vendored copy under that name in sys.modules before
# importing qnxprobe (see raw_image.py for why). If a bug is ever found here,
# fix it upstream and re-vendor at the new commit — do not patch this file in
# place, or it silently drifts from the reviewed, tested original.
