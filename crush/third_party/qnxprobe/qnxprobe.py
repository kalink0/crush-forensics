...
#   commit 10b1addf168bd26ca09d6141945d7efa1bd02260 (2026-09-12)
...
# and filesystem trees this module exposes and adapts them to Crush's VFS
# abstraction, but does not alter the parsing logic itself. If a bug is ever
# found here, fix it upstream and re-vendor at the new commit — do not patch
# this file in place, or it silently drifts from the reviewed, tested original.
#!/usr/bin/env python3
#
